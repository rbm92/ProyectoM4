...
let CarService = class CarService {
    ...
    async findOne(id) {
        try {
            ...
            throw new common_1.HttpException('car not found', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    async create(newCar) {
        try {
            ...
            throw new common_1.HttpException('missing data, car was not added', common_1.HttpStatus.FORBIDDEN);
        }
    }
    async update(carId, newCar) {
        try {
            ...
            throw new common_1.HttpException('missing data, car was not updated', common_1.HttpStatus.FORBIDDEN);
        }
    }
    async delete(carId) {
        try {
            ...
            throw new common_1.HttpException('car not found', common_1.HttpStatus.FORBIDDEN);
        }
    }
};
